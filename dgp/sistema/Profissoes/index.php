    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <h2 class="pt-3">Área de Ocupação</h2>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <?php
            $sql = "
            SELECT  id_profissao, nome_profissao, carga_hora, descricao
            FROM profissoes
            ...
            While($result = mysqli_fetch_array($query)){
              echo"
              <tr>
                  <td>$result[id_profissao]</td>
                  <td>$result[nome_profissao]</td>
                  <td>$result[carga_hora]</td>
                  <td>$result[descricao]</td>
                  <td> 
                  <a href='registro.php?id=$result[id_profissao]' class='btn btn-outline-secondary'>
                  <span data-feather='edit' class='align-text-bottom'></span></a>

                  <a class='btn btn-outline-secondary' href='remover.php?id=$result[id_profissao]'>
