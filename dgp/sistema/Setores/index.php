        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <?php
            $sql = "
            SELECT  id_setor, nome_setor, descricao
            FROM setores
            ORDER BY nome_setor
            ";
            ...
            While($result = mysqli_fetch_array($query)){
              echo"
              <tr>
                  <td>$result[id_setor]</td>
                  <td>$result[nome_setor]</td>
                  <td>$result[descricao]</td>
                  <td> 
                  <a href='registro.php?id=$result[id_setor]' class='btn btn-outline-secondary'>
                  <span data-feather='edit' class='align-text-bottom'></span></a>

                  <a class='btn btn-outline-secondary' href='remover.php?id=$result[id_setor]'>
