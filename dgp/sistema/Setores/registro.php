...
?>
    ...
    <input type="text" class="form-control" id="nome_setor" name="nome_setor" value="<?php echo $nome_setor; ?>">
    </div>
    ...
    <input type="text" class="form-control" id="descricao" name="descricao" value="<?php echo $descricao; ?>">
     ...
     <div class="card-footer">
      ...
      <input  type="hidden" id="id_setor" name="id_setor" value= "<?php echo $id_setor?>">
